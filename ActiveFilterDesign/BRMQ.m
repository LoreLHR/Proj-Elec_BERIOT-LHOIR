function varargout = BRMQ(varargin)

format long e;



% BRMQ M-file for BRMQ.fig
%      BRMQ, by itself, creates a new BRMQ or raises the existing
%      singleton*.
%
%      H = BRMQ returns the handle to a new BRMQ or the handle to
%      the existing singleton*.
%
%      BRMQ('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BRMQ.M with the given input arguments.
%
%      BRMQ('Property','Value',...) creates a new BRMQ or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BRMQ_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BRMQ_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help BRMQ

% Last Modified by GUIDE v2.5 13-Apr-2006 17:44:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BRMQ_OpeningFcn, ...
                   'gui_OutputFcn',  @BRMQ_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BRMQ is made visible.
function BRMQ_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BRMQ (see VARARGIN)

% Choose default command line output for BRMQ
...
% UIWAIT makes BRMQ wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = BRMQ_OutputFcn(hObject, eventdata, handles)
