function varargout = HPHQ(varargin)

format long e;
% HPHQ M-file for HPHQ.fig
%      HPHQ, by itself, creates a new HPHQ or raises the existing
%      singleton*.
%
%      H = HPHQ returns the handle to a new HPHQ or the handle to
%      the existing singleton*.
%
%      HPHQ('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in HPHQ.M with the given input arguments.
%
%      HPHQ('Property','Value',...) creates a new HPHQ or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before HPHQ_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to HPHQ_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help HPHQ

% Last Modified by GUIDE v2.5 13-Apr-2006 19:44:39

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @HPHQ_OpeningFcn, ...
                   'gui_OutputFcn',  @HPHQ_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before HPHQ is made visible.
function HPHQ_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to HPHQ (see VARARGIN)
movegui(hObject,'center')  % To display application in the center of screen

% Choose default command line output for HPHQ
...
% UIWAIT makes HPHQ wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = HPHQ_OutputFcn(hObject, eventdata, handles)
...
%copy-paste
a=textread('HPHQ.cir','%s','delimiter', '');
